 ...
 * 
 * <p>
 * Therefore it corresponds to the polynomial:
 * </p>
 * 
 * <p>
 ...
 * </p>
 */
public final class RabinHashFunction32 implements Cloneable
{
	/**
	...
	public int hash(final char[] A)
	{
		...
		// If an odd number of characters, process the first char so that the
		// number remaining
		...
		while (s < A.length)
		{
			w = computeWShifted(w) ^ ((A[s] & 0xFFFF) << 16)
					^ (A[s + 1] & 0xFFFF);
			s += 2;
		}
	...
	/**
	 * <p>
	 * Returns the Rabin hash value of an array of <code>int</code>s. This
	...
	{
		return o instanceof RabinHashFunction32
				&& ((RabinHashFunction32) o).P == P;
	}
